 ...
 */
const getConfig = () => {
  const { config } = require("includes/core/default_config");
  return { ...config };
};

const testChannel = (recordField) => {
    // console.log(`${recordField}.google_ads_campaign`);
    // console.log(`${recordField}.manual_campaign`);
