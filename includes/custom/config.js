...
const customConfig = {
  ...
  // known limitation: the output column names must be valid. use letters and underscores to be safe 
    {"name": "application_status", "type": "string"},
      ...
      {"name": "order_discount", "type": "string"},
      ...
      {"name": "video_current_type", "type": "string"},
      ...
      {"name": "checkout_step_number", "type": "string"},
      {"name": "colorview_experience", "type": "string"},
      {"name": "cta_name", "type": "string"},
      {"name": "currency", "type": "string"},
      {"name": "date_booked", "type": "string"},
      ...
      {"name": "menu_select_category", "type": "string"},
      {"name": "method", "type": "string"},
      {"name": "nav_item_selected", "type": "string"},
      ...
      {"name": "product_answer_quantity", "type": "string"},
      {"name": "product_question_quantity", "type": "string"},
      {"name": "product_review_quantity", "type": "string"},
      {"name": "product_review_score", "type": "string"},
      {"name": "promotion_name", "type": "string"},
      {"name": "promotion_text", "type": "string"},
      {"name": "question_1", "type": "string"},
      {"name": "question_2", "type": "string"},
      {"name": "question_3", "type": "string"},
      {"name": "question_4", "type": "string"},
      {"name": "question_5", "type": "string"},
      {"name": "recommended_term", "type": "string"},
      {"name": "redeemed_gift_card_ammount", "type": "string"},
      {"name": "search_result_count", "type": "string"},
      ...
      {"name": "sub_dropdown_selection", "type": "string"},
      {"name": "sub_value", "type": "string"},
      {"name": "subcategory", "type": "string"},
      {"name": "subcategory_selection", "type": "string"},
      {"name": "talkativeAction", "type": "string"},
      {"name": "tax", "type": "string"},
      {"name": "time_booked", "type": "string"},
      {"name": "tipping_amount", "type": "string"},
      {"name": "tipping_percentage", "type": "string"},
      {"name": "transaction_id", "type": "string"},
      {"name": "transaction_total", "type": "string"},
      {"name": "use_shipping_address", "type": "string"},
      {"name": "user_id", "type": "string"},
      {"name": "value", "type": "string"},
      {"name": "variant", "type": "string"},
      {"name": "video_duration", "type": "string"},
      {"name": "video_percent", "type": "string"},
      ...
      {"name": "vsu_step_number", "type": "string"},
...
CUSTOM_USER_PROPERTIES_ARRAY: [
 ...
 CUSTOM_ITEM_PARAMS_TO_EXCLUDE: [], // by default,  all custom arams are unnested except thse listed here
  ...
  CUSTOM_ITEM_PARAMS_ARRAY: [
      ...
      {"name": "item_coupon","type": "string"},
      {"name": "item_free_from","type": "string"},
      {"name": "item_free_gift","type": "string"},
      ...
      {"name": "item_review_quantity","type": "string"},
      ...
      {"name": "item_category2","type": "string"},
      {"name": "item_category3","type": "string"},
      {"name": "item_category4","type": "string"},
      ...
      {"name": "item_out_of_scope","type": "string"},
