...
{"name":"bulk_add_type","type":"string"},
...
{"name":"checkout_step_number","type":"int"},
{"name":"creative_format","type":"string"},
{"name":"checkout_step_name","type":"string"},
{"name":"content_group","type":"int"},
{"name":"delivery_fee","type":"decimal"},
{"name":"dw_id","type":"int"},
{"name":"error_message","type":"string"},
{"name":"checkout_type","type":"string"},
{"name":"event_location","type":"string"},
{"name":"filter_action","type":"string"},
{"name":"filter_category","type":"string"},
{"name":"filter_selected","type":"string"},
{"name":"filter_value","type":"int"},
...
{"name":"gclsrc","type":"string"},
{"name":"is_email_subscriber","type":"string"},
{"name":"list_name","type":"string"},
{"name":"login_status","type":"string"},
{"name":"marketing_tactic","type":"string"},
{"name":"monetate_id","type":"string"},
{"name":"monetate_status","type":"string"},
{"name":"nav_click_text","type":"string"},
{"name":"nav_item_selected","type":"int"},
{"name":"nav_level","type":"string"},
{"name":"nav_menu_level","type":"string"},
{"name":"nav_menu_type","type":"string"},
{"name":"nav_type","type":"string"},
{"name":"order_details_shared","type":"int"},
{"name":"order_discount","type":"decimal"},
{"name":"page_breadcrumb","type":"string"},
{"name":"page_name","type":"string"},
{"name":"page_type","type":"string"},
{"name":"password_action_type","type":"string"},
{"name":"personalization_value","type":"string"},
{"name":"product_review_quantity","type":"int"},
{"name":"product_review_score","type":"decimal"},
{"name":"recommended_term","type":"decimal"},
{"name":"remember_me_selected","type":"string"},
{"name":"search_result_count","type":"int"},
{"name":"sort_selected","type":"string"},
{"name":"source_platform","type":"string"},
{"name":"step_name","type":"string"},
{"name":"step_number","type":"int"},
{"name":"tipping_amount","type":"decimal"},
{"name":"tipping_percentage","type":"decimal"},
{"name":"unique_search_term","type":"int"},
{"name":"user_type","type":"string"},
{"name":"vsu_registration_type","type":"string"},
{"name":"vsu_step_name","type":"string"},
{"name":"vsu_step_number","type":"int"},
{"name":"payment_provider","type":"string"},
{"name":"payment_type","type":"string"},
{"name":"points_earned","type":"string"},
{"name":"product_reivew_score","type":"string"},
{"name":"redeemed_gift_card_amount","type":"string"},
...
{"name":"child_account","type":"string"},
{"name":"communication_pref","type":"string"},
{"name":"customer_id","type":"string"},
{"name":"date_of_last_purchase","type":"int"},
{"name":"dw_id","type":"int"},
{"name":"is_email_subscriber","type":"string"},
{"name":"login_status","type":"string"},
{"name":"prevenue_28d","type":"string"},
...
{"name":"user_type","type":"string"},
{"name":"vsu_employee_level","type":"string"},
{"name":"vsu_employee_type","type":"string"},
{"name":"vsu_professional_level","type":"string"},
{"name":"vsu_professional_type","type":"string"},
{"name":"fav_store","type":"string"},
{"name":"text_subscriber","type":"string"}
 ...
 CUSTOM_ITEM_PARAMS_TO_EXCLUDE: [], // by default,  all custom arams are unnested except thse listed here
  ...
  // ]
  CUSTOM_ITEM_PARAMS_ARRAY: [
{"name":"item_badge_name","type":"string"},
{"name":"dimension53","type":"string"},
{"name":"dimension75","type":"string"},
{"name":"dimension62","type":"string"},
{"name":"dimension52","type":"string"},
{"name":"dimension64","type":"string"},
{"name":"dimension79","type":"int"},
{"name":"dimension76","type":"string"},
{"name":"dimension57","type":"string"},
{"name":"item_variant_name","type":"string"},
{"name":"item_fulfillment_method","type":"string"},
{"name":"dimension59","type":"string"},
{"name":"item_sub_brand","type":"string"},
{"name":"dimension56","type":"string"},
{"name":"dimension77","type":"string"},
{"name":"item_coupon","type":"int"},
{"name":"metric5","type":"int"},
{"name":"metric3","type":"decimal"},
{"name":"metric4","type":"decimal"},
{"name":"item_badge_value","type":"string"},
{"name":"item_possible_fulfillment_method","type":"string"},
{"name":"item_cateogry","type":"string"},
{"name":"brand","type":"string"},
{"name":"image_url","type":"string"},
{"name":"url","type":"string"},
{"name":"promotion_name","type":"string"},
{"name":"promotion_id","type":"string"},
{"name":"creative_slot","type":"int"},
{"name":"item_bundle","type":"string"},
{"name":"item_color","type":"string"},
{"name":"item_color_selection","type":"string"},
{"name":"item_free_from","type":"string"},
{"name":"item_gift_card","type":"string"},
{"name":"item_hair_color_type","type":"string"},
{"name":"item_in_wishlist","type":"string"},
{"name":"item_oos","type":"string"},
{"name":"item_promo","type":"string"},
{"name":"item_protection_plan","type":"string"},
{"name":"item_refinement_color","type":"string"},
{"name":"item_review_count","type":"string"},
{"name":"item_review_score","type":"string"}
  ],
